    ...
    <Stack spacing={0}>
      ...
      <Grid item xs={12}>
          <NoTitleCard
            ...
            size="l"
          >
            DORA's Accelerate State of DevOps Report has been selected as the <i>Best
            DevOps Survey/Analysis/Research</i>! This award recognizes 
            research that has significantly and positively impacted the DevOps 
            community.
            <br />
            <br />
